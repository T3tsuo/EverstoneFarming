...
def into_cave():
    # goes into the cave and 1 tile into the cave in between 2.11 seconds to 2.14 seconds
    return random() * 0.03 + 2.11
...
def south_of_city():
    # go south for between 2.2 seconds to 2.25
    return random() * 0.05 + 2.2
